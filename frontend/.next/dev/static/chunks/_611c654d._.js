...
"[project]/components/school-detail-modal.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function Dashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            const fetchSchools = {
                "Dashboard.useEffect.fetchSchools": async ()=>{
                    try {
                        setIsLoading(true);
            ...
            }["Dashboard.useEffect.fetchSchools"];
            fetchSchools();
        }
    }["Dashboard.useEffect"], [
        debouncedSearch,
    ...
    const handleSchoolAdded = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["schoolsAPI"].getAll().then((data)=>setSchools(data.schools));
    };
...
//# sourceMappingURL=_611c654d._.js.map